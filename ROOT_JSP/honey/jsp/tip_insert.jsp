...
<%
	...
	String tipContent = request.getParameter("tipContent");
	...
	try{
	    ...
	    String query = "insert into Tip (Menu_mCode, Client_cId, tipContent, tipAddDay) value (" + mCode + ", '" + cId + "', '" + tipContent + "', date_format(now(), '%Y-%m-%d'));";
