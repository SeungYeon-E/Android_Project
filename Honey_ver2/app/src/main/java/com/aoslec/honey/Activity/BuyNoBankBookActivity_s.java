...
import com.aoslec.honey.Bean.BuyNoBankBook_s;
import com.aoslec.honey.Bean.UserAddress_s;
import com.aoslec.honey.Common.CommonInfo_s;
import com.aoslec.honey.NetworkTask.BuyNoBankNetworkTask_s;
...
public class BuyNoBankBookActivity_s extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_buy_nobankbook_s);
    ...
    private void connectGetData(){
        ...
        urlAddr = CommonInfo_s.hostRootAddr + "Buy_Order_Select_Info.jsp?" + "buyNum=" + BuyNumber;
